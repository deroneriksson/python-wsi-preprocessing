...
def save_display(save, display, info, np_img, slide_num, filter_num, display_text, file_text):
  ...
  if display: display(np_img, display_text)
...
# display(no_green_channel, "No Green Channel")
# mask = no_grays & no_green_channel & no_green_pen & no_blue_pen
# display(mask, "No Grays, No Green Channel, No Green Pen, No Blue Pen")
# display(mask_rgb(rgb, mask), "Original with No Grays, No Green Channel, No Green Pen, No Blue Pen")
...
# display(b, "B Entropy")
# rgb_entropy = r & g & b
# display(rgb_entropy, "RGB Entropy")
# display(mask_rgb(rgb, entropy), "Original with RGB Entropy Mask")
...
# display(r_hist, "Histogram Equalization R")
# display(g_hist, "Histogram Equalization G")
# display(b_hist, "Histogram Equalization B")
# hist_equ = np.dstack((r_hist, g_hist, b_hist))
# np_info(hist_equ, "Histogram Equalization")
# display(hist_equ, "Histogram Equalization Separate Channels")
# np_info(hist_equ, "Histogram Equalization")
# rgb_hist = filter_histogram_equalization(rgb)
# display(rgb_hist, "RGB Histogram Equalization")
...
# display(mask_rgb(rgb, hyst_mask), "RGB with Hysteresis Threshold Mask")
# display(mask_rgb(rgb, entropy_mask), "RGB with Entropy Mask")
# display(mask_rgb(rgb, hyst_and_entropy_mask), "RGB with Hyst and Entropy Masks")
# rem_small_mask = filter_remove_small_objects(hyst_and_entropy_mask, output_type="bool")
# display(mask_rgb(rgb, rem_small_mask), "RGB with Small Objects Removed")
# hed = filter_rgb_to_hed(rgb)
# hema = filter_hed_to_hematoxylin(hed)
# hema_thresh_mask = filter_threshold(hema, 25)
# display(hema_thresh_mask, "Hema Threshold")
# rem_small_and_hema_thresh_mask = rem_small_mask & hema_thresh_mask
# display(mask_rgb(rgb, rem_small_and_hema_thresh_mask), "RGB with Remove Small and Hema Thresh")
# display(mask_rgb(rgb, ~rem_small_and_hema_thresh_mask), "RGB with Remove Small and Hema Thresh, Inverse")
# mask_not_green = filter_green(rgb, green_thresh=200)
# display(mask_rgb(rgb, mask_not_green), "RGB Not Green")
# display(mask_rgb(rgb, ~mask_not_green), "RGB Not Green, Inverse")
# mask_not_gray = filter_grays(rgb)
# display(mask_rgb(rgb, mask_not_gray), "RGB Not Gray")
# display(mask_rgb(rgb, ~mask_not_gray), "RGB Not Gray, Inverse")
# mask_not_gray_or_green = filter_grays(mask_rgb(rgb, mask_not_green))
# display(mask_rgb(rgb, mask_not_gray_or_green), "RGB Not Gray or Green")
# display(mask_rgb(rgb, ~mask_not_gray_or_green), "RGB Not Gray or Green, Inverse")
# mask_not_gray_and_not_green = mask_not_gray & mask_not_green
# display(mask_rgb(rgb, mask_not_gray_and_not_green), "RGB Not Gray and Not Green")
# display(mask_rgb(rgb, ~mask_not_gray_and_not_green), "RGB Not Gray and Not Green, Inverse")
# hist_eq = filter_histogram_equalization(hema)
# display(hist_eq, "Hist Eq")
...
# display(np_img, "Filtered" + mask_percentage_text(mask_percent(np_img)))
# np_info(np_img)
...
# display(np_img, "Entropy" + mask_percentage_text(mask_percent(np_img)))
