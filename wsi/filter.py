...
# display_img(no_green_channel, "No Green Channel")
# mask = no_grays & no_green_channel & no_green_pen & no_blue_pen
# display_img(mask, "No Grays, No Green Channel, No Green Pen, No Blue Pen")
# display_img(mask_rgb(rgb, mask), "Original with No Grays, No Green Channel, No Green Pen, No Blue Pen")
...
# display_img(bin, "Dilation")
# sm_o = filter_remove_small_objects(bin, min_size=20000, output_type="bool")
# display_img(sm_o, "Remove Small Objects")
# sm_h = filter_remove_small_holes(sm_o, min_size=1000, output_type="bool")
# display_img(sm_h, "Remove Small Holes")
# display_img(mask_rgb(rgb, sm_h), "Masked Image")
...
# display_img(erosion, "3")
# result = mask_rgb(rgb, erosion)
# display_img(result, "4")
...
# display_img(mask_rgb(rgb, hyst_mask), "RGB with Hysteresis Threshold Mask")
# display_img(mask_rgb(rgb, entropy_mask), "RGB with Entropy Mask")
# display_img(mask_rgb(rgb, hyst_and_entropy_mask), "RGB with Hyst and Entropy Masks")
# rem_small_mask = filter_remove_small_objects(hyst_and_entropy_mask, output_type="bool")
# display_img(mask_rgb(rgb, rem_small_mask), "RGB with Small Objects Removed")
# hed = filter_rgb_to_hed(rgb)
# hema = filter_hed_to_hematoxylin(hed)
# hema_thresh_mask = filter_threshold(hema, 25)
# display_img(hema_thresh_mask, "Hema Threshold")
# rem_small_and_hema_thresh_mask = rem_small_mask & hema_thresh_mask
# display_img(mask_rgb(rgb, rem_small_and_hema_thresh_mask), "RGB with Remove Small and Hema Thresh")
# display_img(mask_rgb(rgb, ~rem_small_and_hema_thresh_mask), "RGB with Remove Small and Hema Thresh, Inverse")
# mask_not_green = filter_green(rgb, green_thresh=200)
# display_img(mask_rgb(rgb, mask_not_green), "RGB Not Green")
# display_img(mask_rgb(rgb, ~mask_not_green), "RGB Not Green, Inverse")
# mask_not_gray = filter_grays(rgb)
# display_img(mask_rgb(rgb, mask_not_gray), "RGB Not Gray")
# display_img(mask_rgb(rgb, ~mask_not_gray), "RGB Not Gray, Inverse")
# mask_not_gray_or_green = filter_grays(mask_rgb(rgb, mask_not_green))
# display_img(mask_rgb(rgb, mask_not_gray_or_green), "RGB Not Gray or Green")
# display_img(mask_rgb(rgb, ~mask_not_gray_or_green), "RGB Not Gray or Green, Inverse")
# mask_not_gray_and_not_green = mask_not_gray & mask_not_green
# display_img(mask_rgb(rgb, mask_not_gray_and_not_green), "RGB Not Gray and Not Green")
# display_img(mask_rgb(rgb, ~mask_not_gray_and_not_green), "RGB Not Gray and Not Green, Inverse")
# hist_eq = filter_histogram_equalization(hema)
# display_img(hist_eq, "Hist Eq")
